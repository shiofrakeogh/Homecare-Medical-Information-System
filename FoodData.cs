...
namespace HMIS
{
    ...
    {
        static FoodData defaultInstance = new FoodData();
        ...
        private FoodData()
        {
            ...
            this.foodTable = client.GetSyncTable<Food>();
#else
            this.foodTable = client.GetTable<Food>();
#endif
        }

        public static FoodData DefaultManager
        {
            get
            {
        ...
        public async Task DeleteTaskAsync(Food item)
        {
            try
            {
                await foodTable.DeleteAsync(item);
            }
            catch (MobileServiceInvalidOperationException msioe)
            {
